...
| 2 | **대사** | 등장인물 | 만화 **말풍선 = 직사각형** (폭은 컷의 **10%** · 세로로 길게 · 주인공=왼쪽 위, 상대방=오른쪽 위) |
| 2 | **속마음** | 주인공 | 만화 **속마음 풍선 = 타원** (폭은 컷의 10% · 세로는 그 폭에 글자를 넣는 데 필요한 만큼) |
...
- **풍선은 가로 10% · 세로로 길게(2026-09-10: 사용자 지시로 20%→절반)**: 말풍선이 얼굴을 덮지 않게 폭을 컷 폭의 10%로 고정하고, 대사를 그 폭에 맞춰 접어 세로로 늘립니다(글자 크기도 줄여서) · 속마음 타원의 세로는 '그 폭에 글자를 넣는 데 필요한 최소'만 씁니다(세로가 컷 높이의 36%를 넘으면 폭을 14%까지 넓혀 줄 수를 줄입니다)
...
- **몸통은 글자보다必ず 크게** 그려집니다. 폭은 컷의 10% × 2.2(보스트), 최소 높이는 컷의 42%이고,
